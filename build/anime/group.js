...
exports.groupAnime = exports.groupDetail = void 0;
...
const get = (page) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield url_1.default.get(`/group${page ? `?page=${page}` : ''}`, {
        ...
        const list = $('main .loop li a').map((index, elemenet) => {
            var _a, _b;
            return ({
                id: (_a = $(elemenet).attr('href')) === null || _a === void 0 ? void 0 : _a.trim().replace('https://tenshi.moe/group/', '').replace(/\/[\d+]/gi, ''),
...
const groupDetail = (id) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    if (!id)
        return { message: 'limit' };
    try {
        const data = yield url_1.default.get(`/group/${id}`);
        const $ = cheerio_1.default.load(data.data);
...
const groupAnime = (id, page) => __awaiter(void 0, void 0, void 0, function* () {
    if (!id)
        return { message: 'limit' };
    try {
        const data = yield url_1.default.get(`/group/${id}${page ? `?page=${page}` : ''}`, {
            withCredentials: true,
            headers: {
                Cookie: 'loop-view=thumb;'
            }
