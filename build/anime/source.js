...
const get = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield url_1.default.get('/source');
...
const sourceAll = (id, page) => __awaiter(void 0, void 0, void 0, function* () {
    if (!id)
        return { message: 'limit' };
    try {
        const data = yield url_1.default.get(`/source/${id}${page ? `?page=${page}` : ''}`, {
