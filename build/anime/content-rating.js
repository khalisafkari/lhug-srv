...
exports.contentRatingAll = void 0;
...
const get = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield url_1.default.get('/content-rating');
        const $ = cheerio_1.default.load(data.data);
        return $('main .loop li a').map((index, element) => {
            var _a, _b;
            return ({
                id: (_a = $(element).attr('href')) === null || _a === void 0 ? void 0 : _a.trim().replace('https://tenshi.moe/content-rating/', ''),
...
const contentRatingAll = (id, page) => __awaiter(void 0, void 0, void 0, function* () {
    if (!id)
        return { message: 'limit' };
    try {
        const data = yield url_1.default.get(`/content-rating/${id}${page ? `?page=${page}` : ''}`, {
        ...
        log_1.error.error(`${e.toString()}`, {
            date: new Date(),
            route: 'content-rating all'
        });
        throw new Error(e);
    }
});
exports.contentRatingAll = contentRatingAll;
exports.default = () => {
